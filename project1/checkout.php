...
<section class="checkout">
   ...
   <div class="row">
      ...
      <div class="summary">
         ...
         ?>
         <div class="flex">
            <img src="uploaded_files/<?= htmlspecialchars($fetch_get['image']); ?>" class="image" alt="">
            <div>
               <h3 class="name"><?= htmlspecialchars($fetch_get['name']); ?></h3>
               <p class="price"><i class="fa-solid fa-baht-sign"></i> <?= htmlspecialchars($fetch_get['price']); ?> x 1</p>
            </div>
         </div>
         <?php
               } else {
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><i class="fa-solid fa-baht-sign"></i> <?= htmlspecialchars($fetch_product['price']); ?> x <?= htmlspecialchars($fetch_cart['qty']); ?></p>
            </div>
         </div>
         <?php
                     } else {
                        echo '<p class="empty">Product details not found!</p>';
                     }
                  }
               } else {
         ...
         ?>
         <div class="grand-total"><span>grand total :</span><p><i class="fa-solid fa-baht-sign"></i> <?= htmlspecialchars($grand_total); ?></p></div>
      </div>
